...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.theoryLabButton : QPushButton = self.findChild(QPushButton, 'TheoryButton')
        self.exampleLabButton : QPushButton = self.findChild(QPushButton, 'ExampleButton')
        self.variantsLabButton : QPushButton = self.findChild(QPushButton, 'VariantsButton')
